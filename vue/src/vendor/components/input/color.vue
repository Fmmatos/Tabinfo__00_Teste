...
import { tooltip, value__ } from '@/vendor/services/events';
            ...
            <div>
                ...
                <div class="__input__ posr">
                    <div class="flexx flex_ac">
                        <div class="w40 mr5"><input v-model="FORM.v[PROPS.name]" v-bind="tags(PROPS, `text`).attributes" v-on="tags(PROPS, `text`, false).events" /></div>
                        <div class="flex_1"><input type="text" v-model="FORM.v[PROPS.name]" class="design min-w80" maxlength="7" /></div>
                    </div>
                </div>
            </div>
        </div>
